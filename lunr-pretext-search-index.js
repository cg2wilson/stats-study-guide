...
},
{
  "id": "def-statistic",
  "level": "2",
  "url": "statistics-terminology.html#def-statistic",
  "type": "Definition",
  "number": "1.1.9",
  "title": "Statistic.",
  "body": " Statistic  Statistic   A statistic is a value found from looking at a sample of a population.   "
},
{
  "id": "example-3",
  "level": "2",
  "url": "statistics-terminology.html#example-3",
  "type": "Example",
  "number": "1.1.10",
  "title": "(Statistic).",
  "body": " (Statistic)   88% of Oklahomans would support a federal law requiring background checks for all gun purchases, It’s not possible to actually ask millions of people whether they agree. Researchers instead take a poll using a sample of Oklahomans.   "
},
{
  "id": "example-4",
  "level": "2",
  "url": "statistics-terminology.html#example-4",
  "type": "Example",
  "number": "1.1.11",
  "title": "(Statistic).",
  "body": " (Statistic)   40% of Oklahoma City residents report that they have been to at least one Thunder game. It’s very doubtful that anyone polled each resident in Oklahoma City. They took a sample, so they have a statistic.   "
},
{
  "id": "example-5",
  "level": "2",
  "url": "statistics-terminology.html#example-5",
  "type": "Example",
  "number": "1.1.12",
  "title": "(Statistic).",
  "body": " (Statistic)   30% of dog owners poop scoop after their dog. It’s impossible to survey all dog owners—no one keeps an accurate track of exactly how many people own dogs. This data had to be from a sample, so it’s a statistic.   "
},
{
  "id": "types-of-variables",
  "level": "1",
  "url": "types-of-variables.html",
  "type": "Section",
  "number": "1.2",
  "title": "Types of Variables",
  "body": " Types of Variables  "
}
]
